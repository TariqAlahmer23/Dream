  ...
  ar: {
    ...
    paths: {
      ...
      path2: {
        ...
        details: [
          ...
          "يحتاج خبرة ML وبنية تشغيل.",
          "أصعب في ذكر المصدر بدقة.",
          "قد يكون مفيدًا لاحقًا بعد جمع بيانات حقيقية.",
        ],
        badge: "",
      },
      divider: "",
    ...
    ragFit: {
      ...
      cards: [
        ...
        {
          title: "طريق أسرع للـ MVP",
          text: "بدل انتظار بناء Dataset تدريبية ضخمة، يمكننا بناء نسخة أولى تعمل بالكتب الحالية بعد تنظيفها وفهرستها.",
        },
      ],
      takeaway:
